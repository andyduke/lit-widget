...
> **Внимание!** Т.к. миксин `@rl-layout(...)` повторяет свое содержимое для каждой точки перестроения, то в него стоит помещать только специфичные для адаптивности CSS-конструкции.
